...
// var thisIsAnObject = function() {
//   console.log('the module was called');
// };
//
// exports.property = thisIsAnObject();



var thisIsAnObject = function(string) {
  console.log(string);
};

module.exports = thisIsAnObject;
