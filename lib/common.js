...
let anotherObject = 'My biggest weakness is understanding what is asked to be done to the power of ';

let someFunction = function(param) {
  console.log(anotherObject + param);
};

let object = someFunction(3);
