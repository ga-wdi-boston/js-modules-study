...
let practice = (function(hoursToPractice) {
  let number = hoursToPractice;
  let practiceMakesPerfect = 'I want to get into Carnegie Hall, so I need to practice ';

  return function() {
    console.log(practiceMakesPerfect + number + ' hours per day!');
    console.log(practiceMakesPerfect + (number + 1) + ' additional hours per day!');
  };
})(2);
