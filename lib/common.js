...
//started with this
let value = 0;
let thisModule = function(tests) {
  this.tests = tests;
  this.value = value;

  return thisModule.value + 50;
};


//started to write this lost train of thought around 1245am
let thatTest = function(){
  let object = {
    properties: [
      { hair: "brown", eyes: "green"},
      { hair: "green", eyes: 'hazel'}
    ],

    anotherTest: function(now){
      let physicalAttributes;
    }
  };

//realized this was the desired result
  return
  exports.thatTest = thisModule;
  let d = require('dates');
  d.thatTest();
};
//   let object = function(args, error){
//     if
//   }
//   One.prototype.testNow = function() {
//     let results  = [];
