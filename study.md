...
myModule(someArgs).getterMethod;
myModule(someArgs).setterMethod;

The getter returns the value of variable
The setter sets the value of variable
```
...
myModule(someValue, someFunction);
```
